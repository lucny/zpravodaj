<?php
// source: C:\xampp\htdocs\zpravodaj\app/config/config.neon 
// source: C:\xampp\htdocs\zpravodaj\app/config/config.local.neon 

class Container_2ececb4456 extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\xampp\htdocs\zpravodaj\app',
			'wwwDir' => 'C:\xampp\htdocs\zpravodaj\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\xampp\htdocs\zpravodaj\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\zpravodaj\app'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\xampp\htdocs\zpravodaj\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\zpravodaj\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=zpravodaj', 'root', '', array('lazy' => TRUE));
	...
	{
		return new Container_2ececb4456_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\xampp\htdocs\zpravodaj\app/../temp/cache/latte');
...
final class Container_2ececb4456_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
